...
@IdClass(OwnerProductsPk.class)
public class OwnerProductLink implements Persisted, Serializable {
    ...
    public OwnerProductLink() {
        
    }
    
    public OwnerProductLink(String ownerId, String productUuid) {
    ...
    public Serializable getId() {
        return new OwnerProductsPk(ownerId, productUuid);
    }
    ...
    public void setOwner(Owner owner) {
        if (owner.getId() == null)
            throw new IllegalArgumentException("Before creating link Owner-Product you must persist the owner!");
        this.owner = owner;
        ownerId = owner.getId();
    }
    ...
    public void setProduct(Product product) {
        if (owner.getId() == null)
            throw new IllegalArgumentException("Before creating link Owner-Product you must persist the product!");
