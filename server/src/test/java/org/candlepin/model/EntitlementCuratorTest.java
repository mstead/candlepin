...
public class EntitlementCuratorTest extends DatabaseTestFixture {
    ...
    public void testModifyMarketingProduct() {
        Set<Entitlement> result = entitlementCurator.batchListModifying(modifierData.getEntitlements(2));
        ...
        assertEquals("Entitlement 6 should modify entitlement 2", e6Id, result.iterator().next().getId());
    }
    ...
    public void testModifyShouldntIncludeInput() {
        Set<Entitlement> result = entitlementCurator.batchListModifying(modifierData.getEntitlements(2, 6));
    ...
    public void testOutNonExpired() {
        Set<Entitlement> result = entitlementCurator.batchListModifying(modifierData.getEntitlements(3, 13));
    ...
    public void testEntitlementThatDoesntOverlap() {
        Set<Entitlement> result = entitlementCurator.batchListModifying(modifierData.getEntitlements(17));
    ...
    public void testModifyOnlyConsumers() {
        Set<Entitlement> result = entitlementCurator.batchListModifying(modifierData.getEntitlements(3, 8));
        ...
        for (Entitlement r : result) {
            assertTrue(r.getId().equals(e4Id) || r.getId().equals(e5Id) || r.getId().equals(e6Id));
        }
    }
    ...
    public void testModifyConsumerDoesntHaveEntitlement() {
        Set<Entitlement> result = entitlementCurator.batchListModifying(modifierData.getEntitlements(18, 19));
        assertEquals(1, result.size());
        String e15id = modifierData.getEntitlementId(15);
        assertEquals("Expected entitlement is E15", e15id, result.iterator().next().getId());
        assertEquals("Expected consumer is Consumer2", "C2",
            result.iterator().next().getConsumer().getName());
    }
